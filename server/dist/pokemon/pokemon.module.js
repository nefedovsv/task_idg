...
const createDB_service_1 = require("./createDB.service");
const pokemon_schemas_1 = require("./schemas/pokemon.schemas");
let PokemonModule = class PokemonModule {
};
PokemonModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Pokemon', schema: pokemon_schemas_1.PokemonSchema }]),
        ],
        controllers: [pokemon_controller_1.PokemonController],
        providers: [pokemon_service_1.PokemonService, createDB_service_1.DBService],
    })
], PokemonModule);
