...
__decorate([
    ...
    common_1.Get('favouritePokemons'),
    __param(0, common_1.Headers('userdata')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PokemonController.prototype, "findFavourite", null);
__decorate([
    common_1.UseGuards(passport_1.AuthGuard('jwt')),
    common_1.Put('favourite'),
    __param(0, common_1.Body('favourite')),
...
__decorate([
    common_1.UseGuards(passport_1.AuthGuard('jwt')),
    common_1.Delete('favourite:id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PokemonController.prototype, "deleteFavourite", null);
